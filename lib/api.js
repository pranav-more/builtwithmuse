...
// How many site visitors may be handed his code before it is treated as exhausted.

const OWNER_MAX_CLAIMS = 29;
...
await pool.query("INSERT INTO codes (code, source, priority, max_claims) VALUES ($1, 'owner', 1, $2) ON CONFLICT (upper(code)) DO UPDATE SET source='owner', priority=1, max_claims=$2", [OWNER_CODES[0], OWNER_MAX_CLAIMS]);
