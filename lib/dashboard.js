...
const SCRIPT = `
      (() => {
        ...
        $("p-pic").addEventListener("change", () => {
          ...
          if (!/^image\//.test(file.type)) { setStatus("profile-status", "Pick an image file.", "err"); return; }
          const img = new Image();
          img.onload = () => {
        ...
        $("w-shot").addEventListener("change", () => {
          ...
          if (!/^image\//.test(file.type)) { setStatus("editor-status", "Pick an image file.", "err"); return; }
          const img = new Image();
          img.onload = () => {
