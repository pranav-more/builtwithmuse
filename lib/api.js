...
async function claimCode(client, creator, deviceId, ip, fresh, where) {
  ...
  try {
    ...
    // long since the last confirmation. Codes down to their last reported
    // invite sink below everything else. Stale codes sink to the bottom of
    // the order but are never excluded; only retired or twice reported codes
