...
async function pageCreator(handle, req) {
  ...
  return { status: 200, html: layout({ title, description, path: "/creators/" + c.handle, ogType: "profile", current: "/workflows", body, script: SESSION_JS + ACCOUNT_JS, jsonld, noindex: hidden }) };
}
