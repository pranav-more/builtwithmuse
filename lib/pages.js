...
.end-actions { margin: 28px 0; padding: 12px 14px; border: 1px solid var(--line-soft); border-radius: var(--radius); background: rgba(255,255,255,.04); display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
...
.save-icon { width: 38px; height: 38px; flex: 0 0 auto; border: 1px solid var(--line-soft); border-radius: 8px; background: rgba(255,255,255,.05); color: var(--muted-2); display: grid; place-items: center; padding: 0; }
